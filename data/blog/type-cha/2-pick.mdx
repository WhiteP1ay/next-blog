---
title: 类型体操入门 —— keyof/in/泛型约束实现Pick
...
这道题要我们实现一个Pick，Pick作为常用的内置工具类型，我想大家都知道它的作用。简单的举一个例子:
...
// 如此一来，我便从Todo里取出了title和completed
...
还有像[这道题](https://github.com/type-challenges/type-challenges/blob/main/questions/00011-easy-tuple-to-object/README.md)，如何实现把元组转为对象类型？
